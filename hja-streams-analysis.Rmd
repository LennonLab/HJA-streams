...
beta.to.plot <- rbind.data.frame(
  ...
  tibble(position = "Mainstem", habitat = "Sediment", beta = "RC_hel", dist = as.vector(mainstem.dist.sed.tax)),
  tibble(position = "Headwater", habitat = "Planktonic", beta = "RC_hel", dist = as.vector(headwaters.dist.water.tax)),
  tibble(position = "Mainstem", habitat = "Planktonic", beta = "RC_hel", dist = as.vector(mainstem.dist.water.tax)),
  tibble(position = "Headwater", habitat = "Sediment", beta = "bNTI", dist = as.vector(headwaters.dist.sed.phy)),
  tibble(position = "Mainstem", habitat = "Sediment", beta = "bNTI", dist = as.vector(mainstem.dist.sed.phy)),
  tibble(position = "Headwater", habitat = "Planktonic", beta = "bNTI", dist = as.vector(headwaters.dist.water.phy)),
  tibble(position = "Mainstem", habitat = "Planktonic", beta = "bNTI", dist = as.vector(mainstem.dist.water.phy))
)
