...
ggplot(data = pcoa.plot, aes(Dim1, Dim2)) +
  ...
  geom_point(data = subset(pcoa.plot, group == "Sediment"), 
             size = 3, shape = 1, color = "black", size = 3) +
  geom_point(data = subset(pcoa.plot, group == "Water"), 
             size = 3, shape = 2, color = "black", size = 3) +
