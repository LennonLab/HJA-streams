...
hist(mainstem.dist)
headwaters.dist <- as.dist(as.matrix(RC.hel.dist)[which(design$order == 1), which(design$order == 1)])
mainstem.dist <- as.dist(as.matrix(RC.hel.dist)[which(design$order != 1), which(design$order != 1)])

boxplot(as.vector(mainstem.dist), as.vector(headwaters.dist))
```
