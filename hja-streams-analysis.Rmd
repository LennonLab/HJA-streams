...
unique.fig <- unique.fracs %>% 
  ggplot(aes(x = habitat, y = unique_frac, fill = habitat)) + 
  geom_boxplot(color = "gray50") +
...
hja.assembly.plot %>% 
  ggplot(aes(x = den.dists/1000, y = value, linetype = habitat,
...
summary(lm(dist ~ position * habitat, data = subset(beta.to.plot, beta == "bNTI")))
summary(lm(dist ~ position * habitat, data = subset(beta.to.plot, beta == "RC_hel")))
```
