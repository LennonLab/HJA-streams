...
alpha.div <- cbind(design, S.obs, simpsE, shan, simpsD, rare.d, rare.d.2)
```
...
water.core <- OTUsREL[, which(colSums(OTUs.PA[which(design$habitat == "water"),]) > 0.5*length(rownames(OTUs)))]
```
