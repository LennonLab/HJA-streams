...
### Figure 4a: Beta-diversity is highest among headwater streams
```{r, eval=F}
...
for(site in 1:length(rownames(OTUsREL))){
  ...
  site.by.phylum <- matrix(nrow = length(rownames(OTUsREL)), ncol = length(unique(phyla.present)))
...
png(filename = "./figures/Figure5.png",
    width = 1200, height = 1200, res = 96*2)
par(mar = c(5, 5, 2, 2) + 0.1)
boxplot((1-water.frac), (1-sed.frac), names = c("Water", "Sediments"), 
