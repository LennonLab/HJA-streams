...
plot(hja.dists$env.dists, 1 - hja.dists$comm.struc)
plot(hja.dists$den.dists, 1 - hja.dists$comm.struc)
plot(hja.dists$den.dists, hja.dists$env.dists)
plot(hja.dists$geo.dists, hja.dists$env.dists)
plot(hja.dists$geo.dists, 1 - hja.dists$comm.struc)
...
water.dists <- cbind(liste((1 - water.db), entry = "comm.struc"), water.env.dists)
...
sed.dists <- cbind(liste((1-sediment.db), entry = "comm.struc"), sed.env.dists)
