...
pdf(file = "figures/DDR-water.pdf", bg = "white")
par(oma = c(1,1,1,1))
plot.DDRs(water.lms)
dev.off()
...
pdf(file = "figures/DDR-sediment.pdf", bg = "white")
par(oma = c(1,1,1,1))
...
pdf(file = "figures/DDR-headwater.pdf", bg = "white")
par(oma = c(1,1,1,1))
...
pdf(file = "figures/DDR-headwater-seds.pdf", bg = "white")
par(oma = c(1,1,1,1))
...
pdf(file = "figures/DDR-headwater-water.pdf", bg = "white")
par(oma = c(1,1,1,1))
...
pdf(file = "figures/DDR-downstream.pdf", bg = "white")
par(oma = c(1,1,1,1))
...
pdf(file = "figures/DDR-downstream-seds.pdf", bg = "white")
par(oma = c(1,1,1,1))
...
pdf(file = "figures/DDR-downstream-water.pdf", bg = "white")
par(oma = c(1,1,1,1))
...
pdf(file = "figures/DDR-hja.pdf", bg = "white")
par(oma = c(1,1,1,1))
plot.DDRs(hja.lms)
dev.off()
